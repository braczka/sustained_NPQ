...
!-----------------------------------------------------------------------
    ...
    call hist_addfld1d (fname='RHAF', units='fraction', &
	 ...
	 !  BMR 9/4/15
    call hist_addfld1d (fname='STOMATAL_COND', units='s/m', &
         avgflag='A', long_name='lai weighting of stomatal resistance', &
         ptr_pft=pps%stomatal_cond)
...
!        ptr_pft=clm3%g%l%c%p%pef%eflx_lh_tot, default='inactive', c2l_scale_type='urbanf')
         ptr_pft=pef%eflx_lh_tot, default='active', c2l_scale_type='urbanf')
!lje$$$$
...
!         avgflag='A', long_name='Rural heat flux into soil/snow including snow melt', &
    ...
    call hist_addfld1d (fname='FPSN', units='umol/m2/s',  &
         avgflag='A', long_name='photosynthesis', &
         ptr_pft=pcf%fpsn, set_lake=0._r8, set_urb=0._r8)
     
!lje****

    call hist_addfld1d (fname='FSIF', units='W/m2',  &
         avgflag='A', long_name='fluorescence', &
         ptr_pft=pcf%fsif, set_lake=0._r8, set_urb=0._r8)
!lje$$$$

!bmr****
    call hist_addfld1d (fname='FYIELD', units='photon emitted/photon absorbed of PAR',  &
         avgflag='A', long_name='fluorescence yield', &
         ptr_pft=pcf%fyield, set_lake=0._r8, set_urb=0._r8)
	 
    call hist_addfld1d (fname='PYIELD', units='photon emitted/photon absorbed of PAR',  &
         avgflag='A', long_name='photochemical yield', &
         ptr_pft=pcf%pyield, set_lake=0._r8, set_urb=0._r8)
	 
    call hist_addfld1d (fname='FXSAT', units='fraction',  &
         avgflag='A', long_name='ratio of actual/potential electron transport for fluorescence model (ja/qabs)', &
         ptr_pft=pcf%fxsat, set_lake=0._r8, set_urb=0._r8)	 
...
! CH4
    ...
    call hist_addfld1d (fname='CISTAR', units='Pascals', &
             avgflag='A', long_name='intercellular leaf CO2', &
             ptr_pft=pcs%cistar)
    ...
    ! Raczka edit to include components of excess maintenance respiration

    call hist_addfld1d (fname='LEAF_XSMR', units='gC/m^2/s', &
         avgflag='A', long_name='leaf excess maintenance respiration', &
         ptr_pft=pcf%leaf_xsmr)
    
    call hist_addfld1d (fname='FROOT_XSMR', units='gC/m^2/s', &
         avgflag='A', long_name='fine root excess maintenance respiration', &
         ptr_pft=pcf%froot_xsmr)

    call hist_addfld1d (fname='LIVESTEM_XSMR', units='gC/m^2/s', &
         avgflag='A', long_name='stem excess maintenance respiration', &
         ptr_pft=pcf%livestem_xsmr)

    call hist_addfld1d (fname='LIVECROOT_XSMR', units='gC/m^2/s', &
         avgflag='A', long_name='croot excess maintenance respiration', &
         ptr_pft=pcf%livecroot_xsmr)
    ...
    call hist_addfld1d (fname='C13_LEAF_XSMR', units='gC13/m^2/s', &
         avgflag='A', long_name='leaf excess maintenance respiration', &
         ptr_pft=pc13f%leaf_xsmr)
    
    call hist_addfld1d (fname='C13_FROOT_XSMR', units='gC13/m^2/s', &
         avgflag='A', long_name='fine root excess maintenance respiration', &
         ptr_pft=pc13f%froot_xsmr)

    call hist_addfld1d (fname='C13_LIVESTEM_XSMR', units='gC13/m^2/s', &
         avgflag='A', long_name='stem excess maintenance respiration', &
         ptr_pft=pc13f%livestem_xsmr)

    call hist_addfld1d (fname='C13_LIVECROOT_XSMR', units='gC13/m^2/s', &
         avgflag='A', long_name='croot excess maintenance respiration', &
         ptr_pft=pc13f%livecroot_xsmr)
...
! add by F. Li and S. Levis
 ...
 call hist_addfld1d (fname='M_LIVESTEMC_STORAGE_TO_LITTER_FIRE', units='gC/m^2/s', &
    ...
    call hist_addfld1d (fname='CPOOL_TO_LIVESTEMC', units='gC/m^2/s', &
         ...
         ptr_pft=pcf%cpool_to_livestemc)
    ...
    call hist_addfld1d (fname='CPOOL_TO_DEADSTEMC', units='gC/m^2/s', &
         ...
         ptr_pft=pcf%cpool_to_deadstemc)
    ...
    call hist_addfld1d (fname='CPOOL_TO_LIVECROOTC', units='gC/m^2/s', &
         ...
         ptr_pft=pcf%cpool_to_livecrootc)
    ...
    call hist_addfld1d (fname='CPOOL_TO_DEADCROOTC', units='gC/m^2/s', &
         ...
         ptr_pft=pcf%cpool_to_deadcrootc)
...
! Added by Raczka 11/20/14
       call hist_addfld1d (fname='C13_M_LEAFC_TO_LITTER_FIRE', units='gC13/m^2/s', &
            avgflag='A', long_name='C13 leaf C mortality from fire', &
            ptr_pft=pc13f%m_leafc_to_litter_fire, default='inactive')
...
! F. Li and S. Levis
   ...
   call hist_addfld1d (fname='NFIRE',  units='counts/km2/timestep', &
    ...
    call hist_addfld1d (fname='HUM_IGNITIONS',  units='counts/km2/timestep', &
         avgflag='A', long_name='human-caused fire ignitions', &
         ptr_col=cps%lh)

    call hist_addfld1d (fname='TOT_IGNITIONS',  units='counts/km2/timestep', &
         avgflag='A', long_name='total fire ignitions (human & lightning)', &
         ptr_col=cps%ig)
