...
!bmr
   ...
   real(r8), pointer :: xsatsun(:)          ! sunlit ratio of actual/potential electron transport (ja/qabs) for fluorescence model (ja/qabs)
   real(r8), pointer :: xsatsha(:)          ! shaded ratio of actual/potential electron transport (ja/qabs) for fluorescence model (ja/qabs)
