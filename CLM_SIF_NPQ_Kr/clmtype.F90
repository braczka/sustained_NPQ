...
type, public :: pft_pstate_type
   ...
   real(r8), pointer :: stomatal_cond(:)    !lai weighted stomatal conductance [m/s]  BMR 8/6/15
...
type, public :: pft_cstate_type
   ...
   real(r8), pointer :: cistar(:)             ! intercellular CO2 concentration BMR added 5/16/15
...
type, public :: pft_eflux_type
   ...
   real(r8), pointer :: parsun_z(:,:)        !absorbed PAR for sunlit leaves in canopy layer (W/m**2); per unit (lai+sai)
   real(r8), pointer :: parsha_z(:,:)        !absorbed PAR for shaded leaves in canopy layer (W/m**2); per unit (lai+sai)
...
type, public :: pft_cflux_type
   ...
   real(r8), pointer :: ansun(:)          !sunlit net assimilation (umol CO2 /m**2/ s)     BMR 8/6/15
   real(r8), pointer :: ansha(:)          !shaded net assimilation (umol CO2 /m**2/ s)     BMR 8/6/15
...
!lje & XY
   real(r8), pointer :: sifsun(:)         !sunlit leaf SIF (W/m**2)
   real(r8), pointer :: sifsha(:)         !shaded leaf SIF (W/m**2)
   real(r8), pointer :: fsif(:)           !total SIF (W/m**2)
   real(r8), pointer :: sifsun_z(:,:)     !canopy layer: sunlit leaf fluorescence (W/m**2)
   real(r8), pointer :: sifsha_z(:,:)     !canopy layer: shaded leaf fluorescence (W/m**2)
!lje & XY 
!bmr
   real(r8), pointer :: fyield(:)           !fluorescence yield (photon emitted/photon absorbed of PAR)  
   real(r8), pointer :: pyield(:)           !photochemical yield (photon emitted/photon absorbed of PAR)  
   real(r8), pointer :: fxsat(:)            !ratio of actual/potential electron transport (ja/qabs), canopy weighted
   real(r8), pointer :: fxrev(:)            !ratio of actual/potential electron transport (ja/je), canopy weighted
   
   real(r8), pointer :: fyieldsun(:)          ! sunlit fluorescence yield (photon emitted/photon absorbed of PAR)
   real(r8), pointer :: fyieldsha(:)          ! shaded fluorescence yield (photon emitted/photon absorbed of PAR)
   real(r8), pointer :: pyieldsun(:)          ! sunlit photochemical yield (photon emitted/photon absorbed of PAR)
   real(r8), pointer :: pyieldsha(:)          ! shaded photochemical yield (photon emitted/photon absorbed of PAR)  
   real(r8), pointer :: xsatsun(:)          ! sunlit ratio of actual/potential electron transport (ja/qabs) for fluorescence model
   real(r8), pointer :: xsatsha(:)          ! shaded ratio of actual/potential electron transport (ja/qabs) for fluorescence model
   
   real(r8), pointer :: xrevsun(:)          ! sunlit ratio of actual/potential electron transport for fluorescence model (ja/je)
   real(r8), pointer :: xrevsha(:)          ! shaded ratio of actual/potential electron transport for fluorescence model(ja/je)
   
!bmr   
   
   
   real(r8), pointer :: ansun_z(:,:)      !canopy layer: sunlit leaf net assimilation (umol CO2 /m**2/ s)   BMR 8/6/15
   real(r8), pointer :: ansha_z(:,:)      !canopy layer: shaded leaf net assimilation (umol CO2 /m**2/ s)   BMR 8/6/15
...
!  real(r8), pointer :: xirrig(:)             !irrigation rate
   ...
   real(r8), pointer :: lh(:)           ! human ignitions (count/km2/timestep),  
   real(r8), pointer :: ig(:)           ! total ignitions (human & lightining),  
