...
!lje
    real(r8), pointer :: sifsun(:)         ! sunlit leaf solar-induced fluorescence (umol CO2 /m**2/ s)
    real(r8), pointer :: sifsha(:)         ! shaded leaf solar-induced fluorescence (umol CO2 /m**2/ s)
!lje
...
!lje
    real(r8), pointer :: fsif(:)          ! solar-induced fluorescence (umol CO2 /m**2 /s)
!lje
